...
namespace HRMS.Controllers
{
    public class JobPostsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Description,Experience")] JobPost jobPost)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Description,Experience")] JobPost jobPost)
        {
            if (ModelState.IsValid)
            {
